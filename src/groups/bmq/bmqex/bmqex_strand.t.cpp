...
// bmqex_strand.t.cpp                                                 -*-C++-*-
#include <bmqex_strand.h>
...
class ThrowingExecutor {
  ...
  public:
    // ACCESSORS
    BSLA_MAYBE_UNUSED bool operator==(const ThrowingExecutor&) const { return true; }
};
...
//
// Plan:
//   1. Default-construct an instance of 'bmqex::Strand'. Check
//      postconditions. Destroy the object and check that no memory
//      is leaked.
//
//   2. Executor-construct an instance of 'bmqex::Strand'. Check
//      postconditions. Destroy the object and check that no memory
//      is leaked.
//
...
//
// Testing:
//   bmqex::Strand's constructor
//   bmqex::Strand's destructor
// ------------------------------------------------------------------------
{
    ...
    // compiler happiness (unused function template)
    {
...

        {
            ...
            bmqex::Strand<TestExecutionContext::ExecutorType> strand(
                ctx.executor(),
                &alloc);
...
// ------------------------------------------------------------------------
{
    typedef bmqex::Strand<TestExecutionContext::ExecutorType> Strand;
...
//     within the 'bmqex::Strand'.
//
// Testing:
//   bmqex::Strand::outstandingJobs
// ------------------------------------------------------------------------
{
    typedef bmqex::Strand<TestExecutionContext::ExecutorType> Strand;
...
// ------------------------------------------------------------------------
{
    ...
    // 4. exception safety
    {
        ...
        bmqex::Strand<ThrowingExecutor> strand(ThrowingExecutor(), &alloc);
...
//
// Testing:
//   bmqex::Strand::ExecutorType::runningInThisThread
// ------------------------------------------------------------------------
{
    typedef bmqex::Strand<TestExecutionContext::ExecutorType> Strand;
...
//   associated 'bmqex::Strand' object.
//
// Testing:
