...
// bmqst_statcontext.h                                                -*-C++-*-
#ifndef INCLUDED_BMQST_STATCONTEXT
#define INCLUDED_BMQST_STATCONTEXT

//@PURPOSE: Provide a context to manage a set of user-defined stat values.
//
//@CLASSES:
// bmqst::StatContextConfiguration : configuration for a StatContext
// bmqst::StatContextIterator      : iterator of subcontexts
// bmqst::StatContext              : the stat context
//
//@SEE_ALSO:
//  bmqst_statvalue
//  bmqst_statutil
//  bmqst_statcontexttableinfoprovider
//
//@DESCRIPTION: This component defines a mechanism, 'bmqst::StatContext', for
...
/// Statistics
///----------
// The statistics themselves are maintained by a set of 'bmqst::StatValue'
...
// 'bmqst::StatUtil' for the types of statistics that are currently supported
// for a value.
//
// The statistics to be maintained by a 'StatContext' are defined by a
// 'bmqst::StatContextConfiguration' object provided by the application when a
...
// 'bmqst::StatContextTableInfoProvider' for an example of a generic component
// that can be used with the 'bmqst::TableUtil' utility to print a table
...
// 'bmqst::StatContextTableInfoProvider' can be used in a call to
// 'bmqst::TableUtil' to print a table 'StatContext' to a stream.
//
...
// 'bmqstm::StatContextUpdate'.  On each snapshot, the 'StatContext' will
// update the values of the 'bmqstm::StatContextUpdate' to represent the value
...
// 'bmqstm::StatContextUpdate' based on its current state.  This is useful to
...
// 'bmqst::StatContextConfiguration'.  Notice that
// 'bmqst::StatContextConfiguration' methods all return a reference to the
...
//..
//  tip.addColumn("Bytes", e_IN, bmqst::StatUtil::value, 0);
//..
...
//..
//  tip.addColumn("Bytes/s", e_IN, bmqst::StatUtil::rate, 10, 0);
//..
...
//..
//  tip.addColumn("Messages", e_IN, bmqst::StatUtil::increments, 0);
//..
// Finally, we want "Messages/s" which shows the rate of increments of the
// e_IN value from the 10th to the 0th snapshot.
//..
//  tip.addColumn("Messages/s", e_IN, bmqst::StatUtil::incrementRate, 10, 0);
//..
// Now we add similar columns for the output statistics
//..
//  tip.setColumnGroup("Out");
//  tip.addColumn("Bytes", e_OUT, bmqst::StatUtil::value, 0);
//  tip.addColumn("Bytes/s", e_OUT, bmqst::StatUtil::rate, 10, 0);
//  tip.addColumn("Messages", e_OUT, bmqst::StatUtil::increments, 0);
//  tip.addColumn("Messages/s", e_OUT, bmqst::StatUtil::incrementRate, 10, 0);
//..
...
// StatContext.
//..
//  bslma::ManagedPtr<bmqst::StatContext> client1 =
//        context.addSubcontext(bmqst::StatContextConfiguration("tcp://1234"));
...
//  tip.addDefaultIdColumn("");
//  tip.setColumnGroup("In");
//  tip.addColumn("Bytes", 0, bmqst::StatUtil::value, 0);
//  tip.addColumn("Bytes/s", 0, bmqst::StatUtil::rate, 10, 0);
//  tip.addColumn("Messages", 0, bmqst::StatUtil::increments, 0);
//  tip.addColumn("Messages/s", 0, bmqst::StatUtil::incrementRate, 10, 0);
//  tip.update();
//
//  if (verbose) {
//      bmqst::TableUtil::printTable(bsl::cout, tip);
...
//..
//  bmqst::StatContext context(bmqst::StatContextConfiguration("Allocator")
...
//..
//  bslma::ManagedPtr<bmqst::StatContext> subContext = context.addSubcontext(
//                     bmqst::StatContextConfiguration("Interface Allocator")
//                                             .value("Memory", numSnapshots));
//..
...
//  tip.setColumnGroup("In");
//  tip.addColumn("Bytes", 0, bmqst::StatUtil::value, 0);
//  tip.addColumn("Avg", 0, bmqst::StatUtil::average, 10, 0);
//  tip.addColumn("Min", 0, bmqst::StatUtil::absoluteMin);
//  tip.addColumn("Max", 0, bmqst::StatUtil::absoluteMax);
//  tip.update();
//  if (verbose) {
//      bmqst::TableUtil::printTable(bsl::cout, tip);
//  }
...
class StatContext {
  ...
  private:
    ...
    bmqstm::StatContextUpdate* d_update_p;
    ...
    void applyUpdate(const bmqstm::StatContextUpdate& update);
...
class StatContextConfiguration {
  private:
    ...
    bmqstm::StatContextUpdate*           d_updateCollector_p;
  ...
  public:
    ...
    /// bmqstm::StatContextUpdateFlags::E_CONTEXT_CREATED' and
    ...
    explicit StatContextConfiguration(const bmqstm::StatContextUpdate& update,
                                      bslma::Allocator* basicAllocator = 0);
    ...
    /// `valueFieldMask & (1 << bmqst::StatValueField::FIELD)`.  Note that
...
// FREE OPERATORS
inline bsl::ostream& bmqst::operator<<(bsl::ostream&      stream,
