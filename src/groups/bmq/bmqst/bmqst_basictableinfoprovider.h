...
// bmqst_basictableinfoprovider.h -*-C++-*-
#ifndef INCLUDED_BMQST_BASICTABLEINFOPROVIDER
#define INCLUDED_BMQST_BASICTABLEINFOPROVIDER

//@PURPOSE: Provide an adapter of 'bmqst::BaseTable' to
//'bmqst::TableInfoProvider'
//
//@CLASSES:
// bmqst::BasicTableInfoProvider
//
//@DESCRIPTION: This component defines a mechanism,
// 'bmqst::BasicTableInfoProvider', which adapts the 'bmqst::BaseTable'
// protocol to the 'bmqst::TableInfoProvider' protocol.  It allows the user to
// specifiy exactly how a 'bmqst::BaseTable' should be printed.
...
class BasicTableInfoProvider : public bmqst::TableInfoProvider {
  ...
  public:
    ...
    BasicTableInfoProvider(bmqst::BaseTable* table,
                           bslma::Allocator* basicAllocator = 0);
    ...
    void setTable(bmqst::BaseTable* table);
