...
class Domain {
    ...
    // INSTANCE DATA
    bsls::Types::Uint64                   d_messageTtl;
  ...
  public:
    ...
    bsls::Types::Uint64 messageTtl() const;
...
inline bsls::Types::Uint64& Domain::messageTtl()
{
    return d_messageTtl;
}
...
inline bsls::Types::Uint64 Domain::messageTtl() const
{
    return d_messageTtl;
}
